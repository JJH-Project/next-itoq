    ...
    return (
        <div>
            <div className="container mx-auto px-5 py-24">
                <h2 className="title-font mb-8 text-center text-lg tracking-wider text-gray-900">
                    {data.title}
                </h2>
            ...
            <div className="mx-auto flex w-full justify-end space-x-4 md:w-1/3 lg:w-1/4">
                <button
                    type="button"
                    onClick={() => router.back()}
